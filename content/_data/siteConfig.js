...
module.exports = {
  ...
  site: {
    ...
    description: 'Homepage for @grysvn',
    ...
    url: process.env.URL || `https://grysvn.com/`,
    ...
    fediverse: [
      {
        ...
        url: 'https://mastodon.social/@grysvn',
      },
    ],
  },
  // ---------------------------------------------------------------------------
